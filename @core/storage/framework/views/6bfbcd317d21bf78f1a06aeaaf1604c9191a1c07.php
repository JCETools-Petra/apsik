                    ...
                    <div class="card-body">
                       <div class="header-wrap d-flex align-content-center justify-content-between">
                           ...
                           <div class="right-wrap">
                               <a href="<?php echo e(route('admin.blog.new')); ?>" class="btn btn-primary"><?php echo e(__('Create New Blog')); ?></a>
                           </div>
                       </div>
                                    ...
                                    <table class="table table-default" id="all_blog_table">
                                        ...
                                        <?php $__currentLoopData = $blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($data->title); ?> <?php if(!empty($data->breaking_news === 1)): ?><small class="breaking-news"><?php echo e(__('Breaking News')); ?></small><?php endif; ?> <?php if(!empty($data->video_url)): ?><small class="video"><?php echo e(__('Video')); ?></small><?php endif; ?></td>
                                                <td>
                                                    <?php
                                                ...
                                                <td>
                                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-popover','data' => ['url' => route('admin.blog.delete',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                                    ...
                                                    <a class="btn btn-xs btn-primary btn-xs mb-3 mr-1" href="<?php echo e(route('admin.blog.edit',$data->id)); ?>">
                                                        <i class="ti-pencil"></i>
                                                    </a>
                                                    <a class="btn btn-xs btn-primary btn-xs mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.blog.single', $data->slug)); ?>">
                                                        <i class="ti-eye"></i>
                                                    </a>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/apsx2353/public_html/@core/resources/views/backend/pages/blog/index.blade.php ENDPATH**/ ?>