        ...
        $(document).on('click','.media_upload_modal_submit_btn',function (e) {
            ...
            if( typeof allData != 'undefined'){
                ...
                $.each(allData,function(index,value){
                    ...
                    mainUploadBtn.parent().find('.img-wrap').append('<div class="rmv-span"><i class="<?php echo e($trash_icon); ?>"></i></div><div class="attachment-preview"><div class="thumbnail"><div class="centered"><img src="'+el.imgsrc+'"></div></div></div>');
                });
...
<?php /**PATH /home/apsx2353/public_html/@core/resources/views/components/media/js.blade.php ENDPATH**/ ?>