...
<?php endif; ?>
                                                    <?php endif; ?>
                                                    <a class="btn btn-xs btn-primary btn-sm mb-3 mr-1" href="<?php echo e(route('admin.menu.edit',$data->id)); ?>">
                                                        <i class="ti-pencil"></i>
                                                    </a>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/apsx2353/public_html/@core/resources/views/backend/pages/menu/menu-index.blade.php ENDPATH**/ ?>