<script>
    ...
    $(document).on('click','.store_quick_view',function(){
        let el = $(this);
        let initialQuantity = $('#quantity_single_quick_view_btn').val();

        $('.add_cart_from_quick_view').attr('data-product_quantity', initialQuantity);
        quick_view_data(el);
    });
...
</script><?php /**PATH /home/apsx2353/public_html/@core/resources/views/components/frontend/product/quick-view-js.blade.php ENDPATH**/ ?>