...
<?php endif; ?>
                                                        ...
                                                        <form action="<?php echo e(route('admin.all.frontend.user.email.status')); ?>" method="post">
                                                            ...
                                                            <input type="hidden" value="<?php echo e($data->email_verified === "0" ? 1 : 0); ?>" name="email_verified">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/apsx2353/public_html/@core/resources/views/backend/frontend-user/all-user.blade.php ENDPATH**/ ?>