            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.form.builder.event.attendance.form')); ?>" method="Post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/apsx2353/public_html/@core/resources/views/backend/form-builder/event-attendance-form.blade.php ENDPATH**/ ?>