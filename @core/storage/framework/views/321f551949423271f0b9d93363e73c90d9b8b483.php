                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.maintains.page.settings')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label><?php echo e(__('Countdown')); ?></label>
                                <input type="date" name="maintain_page_countdown" class="form-control" value="<?php echo e(get_static_option('maintain_page_countdown')); ?>">
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/apsx2353/public_html/@core/resources/views/backend/maintain-page/maintain-page-index.blade.php ENDPATH**/ ?>