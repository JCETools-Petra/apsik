                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="video_url" value="<?php echo e($blog_post->video_url); ?>">
                                    </div>
                                    <div class="form-group">
...
<?php $__env->startSection('script'); ?>
    ...
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.auto-slug-js','data' => ['url' => route('admin.blog.slug.check'),'type' => 'update']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/apsx2353/public_html/@core/resources/views/backend/pages/blog/edit.blade.php ENDPATH**/ ?>